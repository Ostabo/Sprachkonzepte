...
\begin{figure}[h]
    \centering
    \subfloat[\centering Input: new Object(1, 2)]{{ \includegraphics[width=10cm]{media/Aufgabe2a_parseTree_simple} }}
    \qquad
    \subfloat[\centering Input: new Object(1, new Array())]{{ \includegraphics[width=10cm]{media/Aufgabe2a_parseTree} }}
